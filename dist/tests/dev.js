...
import { BinaryWsvEncoder, WsvDocument } from "../src/wsv.js";
import * as fs from 'node:fs';
function writeBytesSync(bytes, filePath) {
    fs.writeFileSync(filePath, bytes);
}
const text = `a 	U+0061    61            0061        "Latin Small Letter A"
...
const jaggedArray = WsvDocument.parseAsJaggedArray(text);
const bytes = BinaryWsvEncoder.encodeJaggedArray(jaggedArray);
writeBytesSync(bytes, "Table1.bwsv");
console.log("Dev");
